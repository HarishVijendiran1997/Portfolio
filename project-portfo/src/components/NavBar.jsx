...
const NavBar = () => {
    ...
    return (
        <div className="bg-black text-gray-400 max-w-[1200px] mx-auto h-24 flex justify-between items-center px-6">
            {/* Logo */}
            <h1 className="text-3xl font-bold bg-gradient-to-r text-transparent bg-clip-text from-orange-500 to-pink-500">Harish Vijendiran</h1>
            ...
            <div className={`fixed top-0 left-0 h-full w-[60%] bg-[#202121] transition-all duration-500 z-50 ${nav ? "left-0" : "left-[-100%]"}`}>
                <h1 className="text-3xl bg-gradient-to-r text-transparent bg-clip-text from-orange-500 to-pink-500 m-4 ">Harish Vijendiran</h1>
